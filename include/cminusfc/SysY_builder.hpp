...
class SysYBuilder : public ASTVisitor {
  public:
    SysYBuilder() {
        ...
        auto *putchar_fun = Function::create(putchar_type, "putchar", module.get());
        ...
        auto *getarray_type = FunctionType::get(TyVoid, getarray_params);
        auto *getarray_fun = Function::create(getarray_type, "getarray", module.get());

        std::vector<Type *> getfarray_params;
        getfarray_params.push_back(TyFloat32ptr);
        auto *getfarray_type = FunctionType::get(TyVoid, getfarray_params);
        ...
        putfarray_params.push_back(TyFloat);
        ...
        scope.push("putchar", putchar_fun);
